...
function Consent({
  ...
  return (
    <div className="grid gap-1.5">
      <label
        className={`flex items-start gap-3 rounded-xl border bg-white p-4 text-sm text-stone-700 transition hover:border-stone-300 has-[:checked]:border-emerald-300 has-[:checked]:bg-emerald-50/60 ${
